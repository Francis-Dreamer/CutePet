...
public class UpPhotoAdapter extends BaseAdapter {
	...
	public UpPhotoAdapter() {

	}

	@SuppressLint("UseSparseArrays") 
	public UpPhotoAdapter(Context context, List<String> data) {
		this.data = data;
	...
	public static void setIsSelected(Map<Integer, Boolean> isSelected) {
		UpPhotoAdapter.isSelected = isSelected;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == 0) {
			holder.iv_picture.setImageResource(Integer.parseInt(data.get(0)));
			holder.cb_check.setVisibility(View.GONE);
		} else {
			holder.iv_picture.setImageBitmap(SDCardAllPhotoUtil
